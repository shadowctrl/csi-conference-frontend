  ...
  return (
    <div className="scroll-lock">
      ...
      <Main>
        ...
        <Details>
          <div className="">
            <span className="text-3xl grid_head">
              The nominal rates for advertising in the Souvenir:
            </span>
            <Grid className="zoomin  grid grid-flow-row grid-cols-2 rounded-3xl p-8 gap-y-16 md:gap-x-40 md:ml-[200px] md:mr-[200px] text-center ">
              <div>Inside Front Cover </div>
              <div className=" text-red-600"> Rs.20000</div>
              <div className=" text-2xl"> Inside Back Cover </div>
              <div className=" text-red-600  ">Rs.10000</div>
              <div> Back Cover</div>
              <div className=" text-red-600  ">Rs.15000</div>
              <div> Full Page</div>
              <div className=" text-red-600  ">Rs.8000</div>
            </Grid>
          </div>
        </Details>
      </Main>
